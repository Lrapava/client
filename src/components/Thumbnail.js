...
export default function Thumbnail({id, name, img, tags, authors}) {
    return (
        <div className="thumbnail">
            <Link className="thumbnail--link" to={`/client/project/${id}`}>
                <div className="thumbnail--image" style={{backgroundImage: `url("https://Lrapava.github.io/client/projects/${id}/${img}")`}}></div>
